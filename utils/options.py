...
def parse_args():
    ...
    # Model Parameters.
    parser.add_argument("--model", type=str, default="MambaMIL", help="type of model (default: meanmil)")
    parser.add_argument("--rate_global", type=int, default=10, help="rate of MambaMIL")
    parser.add_argument("--mamba_type", type=str, default="SRMamba", help="type of Mamba")
    parser.add_argument("--mamba_layer", type=int, default=2, help="layer of Mamba")
    parser.add_argument("--mamba_rate", type=int, default=10, help="rate of SRMamba in MambaMIL")

    # Optimizer Parameters + Survival Loss Function
    parser.add_argument("--optimizer", type=str, choices=["Adam", "AdamW", "RAdam", "PlainRAdam", "Lookahead", "SGD"], default="Adam")
    parser.add_argument("--scheduler", type=str, choices=["exp", "step", "plateau", "cosine", "None"], default="cosine")
